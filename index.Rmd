...
|-------------------------------------------|------------------------|-------------------------------------------------------------------|
| Precourse Exercise                        | 6%                     | Completed by 11:59 pm on Sunday of Week 1 (04/04/2020).            |
...
I expect the average grade received for this course to be ~85% with a standard deviation of 5. To avoid potential grade inflation and to maintain fairness across different courses at the University of Oregon, I reserve the right to scale grades to conform to this distribution.

<!--
```{r}
set.seed(1)

hist(rnorm(20, 85, 8), breaks = seq(60, 110, 3))
```
-->
